...
class WithoutMixinParamTestCase(SimpleTestCase):
    ...
    def test_get_params(self):
        ...
        self.assertContains(response, "Received a GET with params: {&#39;value&#39;: &#39;2&#39;}")
    
    def test_post_params(self):
        response = Client().post('/', {'value': 2})
        self.assertContains(response, "Received a POST with params: {&#39;value&#39;: &#39;2&#39;}")
    
    def test_put_params(self):
        response = Client().put('/', {'value': 2})
        self.assertContains(response, "Received a PUT with params: {&#39;value&#39;: &#39;2&#39;}")
    
    def test_patch_params(self):
        response = Client().patch('/', {'value': 2})
        self.assertContains(response, "Received a PATCH with params: {&#39;value&#39;: &#39;2&#39;")
